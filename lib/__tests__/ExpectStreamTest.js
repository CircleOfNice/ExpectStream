...
var ReadStream = function (_Readable) {
    ...
    function ReadStream() {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(this, (ReadStream.__proto__ || (0, _getPrototypeOf2.default)(ReadStream)).call(this, { objectMode: true }));
    ...
    (0, _createClass3.default)(ReadStream, [{
        ...
        value: function _read() {
            this.push((0, _lodash2.default)(this.messages) ? this.messages.shift() : this.messages);
        }
    }]);
    return ReadStream;
}(_stream.Readable);
...
describe("ExpectStreamTest", function () {
    ...
    it("uses the produce assertion with a readstream, matching exactly", function (done) {
        (0, _index.expect)(new ReadStream(["lala1", "lala2", "lala3"])).to.produce(["lala1", "lala2", "lala3"]).notify(done);
    });
    ...
    it("uses the produce assertion with a readstream, matching exactly and fails", function (done) {
        var stream = new ReadStream(["lala1", "lala", "lala3"]);
    ...
    it("uses the produce assertion with a readstream, matching not exactly", function (done) {
        var stream = new ReadStream(["lala1", "lala", "lala2", "lala3"]);
    ...
    it("uses the produce assertion with a readstream, matching exactly, but filtering some messages", function (done) {
        (0, _index.expect)(new ReadStream(["lala1", "lala", "lala2", "lala3"])).filter(function (value) {
            return value !== "lala";
